...
var _Spinner = _interopRequireDefault(__webpack_require__(157));

var _Task = _interopRequireDefault(__webpack_require__(160));

var _Checkbox = _interopRequireDefault(__webpack_require__(11));

var _CheckboxConfig = __webpack_require__(10);
...
class Scheduler extends _react.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "_tasksSorting", (a, b) => {
  ...
  render() {
    ...
    const tasksJSX = tasks.filter(task => !task.message.toLocaleLowerCase().search(tasksFilter)).sort(this._tasksSorting).map(task => _react.default.createElement(_Task.default, _extends({
      key: task.id
    }, task, {
    ...
    return _react.default.createElement("section", {
    ...
    }), _react.default.createElement("button", null, "Add task")), _react.default.createElement("div", {
      ...
      duration: 400
    }, tasksJSX)))), _react.default.createElement("footer", null, _react.default.createElement(_Checkbox.default, _extends({
...
var _stylesM = _interopRequireDefault(__webpack_require__(158));
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.23de4.js.map