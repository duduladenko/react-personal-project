...
exports.actionConfig = exports.checkTaskConfig = exports.checkAllConfig = void 0;
const checkAllConfig = {
  color1: "#363636",
  color2: "#fff"
};
exports.checkAllConfig = checkAllConfig;
const checkTaskConfig = {
  color1: "#3B8EF3",
  color2: "#FFF"
};
exports.checkTaskConfig = checkTaskConfig;
const actionConfig = {
  color1: "#3B8EF3",
  color2: "#000"
};
...
*/
var aa=__webpack_require__(4),ba=__webpack_require__(1),m=__webpack_require__(140),p=__webpack_require__(3),v=__webpack_require__(6),da=__webpack_require__(141),ea=__webpack_require__(142),fa=__webpack_require__(143),ha=__webpack_require__(5);
...
var _Spinner = _interopRequireDefault(__webpack_require__(156));

var _Task = _interopRequireDefault(__webpack_require__(159));

var _Checkbox = _interopRequireDefault(__webpack_require__(10));

var _CheckboxConfig = __webpack_require__(9);
...
class Scheduler extends _react.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "_createTaskOnEnter", event => {
      if (event.key === 'Enter') this._createTaskAsync(event);
    });
    ...
    _defineProperty(this, "_updateTasksFilter", event => {
      ...
      this.setState({
        tasksFilter: tasksFilter.toLocaleLowerCase()
      });
    });
    ...
    _defineProperty(this, "_updateTaskAsync", async taskShape => {
      try {
        this._setTasksFetchingState(true);

        const updatedTask = await _REST.api.updateTask(taskShape);
        this.setState(prevState => ({
    ...
    _defineProperty(this, "_completeAllTasksAsync", async () => {
      try {
        ...
        const uncompletedTaskShapes = tasks.filter(task => !task.completed).map(task => ({
          id: task.id,
          completed: true,
          favorite: task.favorite,
          message: task.message
        }));
        if (uncompletedTaskShapes.length === 0) return null;

        this._setTasksFetchingState(true);

        await _REST.api.completeAllTasks(uncompletedTaskShapes);
        this.setState(prevState => ({
  ...
  render() {
    ...
    const tasksJSX = tasks.filter(task => !task.message.toLocaleLowerCase().search(tasksFilter)).map(task => _react.default.createElement(_Task.default, _extends({
      key: task.id
    }, task, {
    ...
    }), _react.default.createElement("main", null, _react.default.createElement("header", null, _react.default.createElement("h1", null, "Task sheduler"), _react.default.createElement("input", {
    ...
    }), _react.default.createElement("button", null, "Add task")), _react.default.createElement("ul", null, tasksJSX)), _react.default.createElement("footer", null, _react.default.createElement(_Checkbox.default, _extends({
      checked: this._getAllCompleted()
    }, _CheckboxConfig.checkAllConfig, {
...
const api = {
  fetchTasks: async () => {
    ...
    if (response.status !== 200) throw new Error('Tasks fetching has been failed.');
    const {
      data: tasks
    } = await response.json();
    return tasks;
  ...
  createTask: async message => {
    ...
    if (response.status !== 200) throw new Error('Task hasn\'t been created');
    const {
      data: task
    } = await response.json();
    return task;
  ...
  async removeTask(id) {
    ...
    if (response.status !== 204) throw new Error('Task hasn\'t been deleted');
  },
  ...
  async updateTask(taskShape) {
    ...
    if (response.status !== 200) throw new Error('Task hasn\'t been updated');
    const {
      data: tasks
    } = await response.json();
    return tasks[0];
  ...
  async completeAllTasks(taskShapes) {
    const promises = taskShapes.map(taskShape => fetch(_config.MAIN_URL, {
      method: 'PUT',
      headers: {
        authorization: _config.TOKEN,
        'content-type': 'application/json'
    ...
    responses.forEach(response => {
      if (response.status !== 200) throw new Error('Tasks haven\'t been updated');
    });
  }
...
var _stylesM = _interopRequireDefault(__webpack_require__(160));

var _CheckboxConfig = __webpack_require__(9);

var _Checkbox = _interopRequireDefault(__webpack_require__(10));

var _Star = _interopRequireDefault(__webpack_require__(171));

var _Edit = _interopRequireDefault(__webpack_require__(172));

var _Remove = _interopRequireDefault(__webpack_require__(173));
...
class Task extends _react.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "_updateTaskMessageOnClick", () => {
      ...
      if (isTaskEditing) this._updateTask();else this._setTaskEditingState(true);
      return null;
    });
    ...
    _defineProperty(this, "_updateTaskMessageOnKeyDown", event => {
      const {
        newMessage
      } = this.state; //it's a test requirement but it breaks UI usability when user fully clear editing field and tries to cancel changes

      if (!newMessage) return null;
      if (event.key === 'Enter') this._updateTask();else if (event.key === 'Escape') this._cancelUpdatingTaskMessage();
    });
  }
  ...
  render() {
    ...
    return _react.default.createElement("li", {
      ...
      inlineBlock: true
    }, _CheckboxConfig.checkTaskConfig, {
      checked: completed,
      ...
      inlineBlock: true
    }, _CheckboxConfig.actionConfig, {
      checked: favorite,
      className: _stylesM.default.toggleTaskFavoriteState,
      onClick: this._toggleTaskFavoriteState
    })), _react.default.createElement(_Edit.default, _extends({
      inlineBlock: true
    }, _CheckboxConfig.actionConfig, {
      checked: isTaskEditing,
      className: _stylesM.default.updateTaskMessageOnClick,
      onClick: this._updateTaskMessageOnClick
    })), _react.default.createElement(_Remove.default, _extends({
      inlineBlock: true
    }, _CheckboxConfig.actionConfig, {
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.c3a36.js.map