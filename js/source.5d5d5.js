...
var _CheckboxConfig = __webpack_require__(135);
...
class Scheduler extends _react.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "_removeTaskAsync", async id => {
      try {
        ...
        const success = await _REST.api.removeTask(id);
        this.setState(prevState => ({
    ...
    _defineProperty(this, "_completeAllTasksAsync", async () => {
      try {
        ...
        const updatedTasks = await _REST.api.completeAllTasks(uncompletedTaskShapes);
        this.setState(prevState => ({
  ...
  render() {
    ...
    const spinnerJSX = isTasksFetching ? _react.default.createElement(_Spinner.default, null) : null;
    ...
    }, _react.default.createElement("main", null, spinnerJSX, _react.default.createElement("header", null, _react.default.createElement("h1", null, "Task sheduler"), _react.default.createElement("input", {
      type: "text",
      placeholder: "Search"
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.5d5d5.js.map